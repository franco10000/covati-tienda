  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 p-4 backdrop-blur-sm">
      <div className="relative w-full max-w-2xl max-h-[90vh] flex flex-col rounded-3xl bg-white shadow-2xl overflow-hidden">
        ...
        <button
          onClick={onClose}
          className="absolute right-4 top-4 z-20 flex h-8 w-8 items-center justify-center rounded-full bg-covati-cream/80 p-2 text-covati-brown hover:bg-covati-sand shadow-sm"
            ...
            <div className="flex flex-col justify-between w-full">
              ...
              <div className="mt-6">
                ...
                <button
                  ...
                  className="w-full rounded-full bg-covati-brown py-3 text-sm font-medium text-white transition-colors hover:bg-covati-taupe disabled:cursor-not-allowed disabled:opacity-50 shadow-sm"
                >
